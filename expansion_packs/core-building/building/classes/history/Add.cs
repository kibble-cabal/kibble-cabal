...
{
    public struct Add<T>(RBuilding building, T component) : IItem where T : IBuildingComponent<T>
    {
        public string Name = $"Add {typeof(T).Name}";
        ...
        private readonly void _Do() => Building.Add(Component);
        private readonly void _Undo() => Building.Remove(Component);
    }
}