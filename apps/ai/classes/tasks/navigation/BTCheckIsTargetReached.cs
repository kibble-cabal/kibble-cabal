...
{
    /// <summary>
    /// Succeeds if the target is reached for a given NavigationAgent.
    /// </summary>
    [Tool]
    public partial class BTCheckIsTargetReached : BTAction
    {
        [Export]
        ...
        public override Status _Tick(double delta)
        {
            ...
            return navigationAgent.IsTargetReached().AsStatus();
        }
    }
}